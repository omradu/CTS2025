public class ManagerM2 extends BugetApprover{
    public static final int MAXIMUM_BUDGET = 1500;
    ...
    public void approveBudget(float amount) {
        ...
        } else
        {
            if(nextApprover!=null) {
                System.out.println("Budget not approved by M2, going to next level");
